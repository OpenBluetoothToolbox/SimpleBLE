...
constexpr auto kDocsServiceIncludedServices = R"pbdoc(
    Included services of the service
)pbdoc";
...
void wrap_service(py::module& m) {
    ...
    py::class_<SimpleBLE::Service>(m, "Service", kDocsService)
        ...
        .def("included_services", &SimpleBLE::Service::included_services, kDocsServiceIncludedServices);
}
