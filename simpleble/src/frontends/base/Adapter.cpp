...
std::string Adapter::identifier() const { return (*this)->identifier(); }
...
std::vector<Peripheral> Adapter::scan_get_results() { return build_vec((*this)->scan_get_results()); }

std::vector<Peripheral> Adapter::get_paired_peripherals() { return build_vec((*this)->get_paired_peripherals()); }
