...
void LocalInterface::load(Holder options) {
...
void LocalInterface::unload() { _loaded = false; }

bool LocalInterface::is_loaded() const { return _loaded; }
...
void LocalInterface::property_refresh(const std::string& property_name) {
...
void LocalInterface::property_changed(std::string option_name) {}

// ----- SIGNALS -----

void LocalInterface::signal_property_changed(Holder changed_properties, Holder invalidated_properties) {
    _property_update_mutex.lock();
